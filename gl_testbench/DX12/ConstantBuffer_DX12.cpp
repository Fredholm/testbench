...
ConstantBuffer_DX12::ConstantBuffer_DX12(std::string NAME, unsigned int location)
{
    ...
    CD3DX12_CPU_DESCRIPTOR_HANDLE   cpuHandle(SceneDescHeap->GetCPUDescriptorHandleForHeapStart());
